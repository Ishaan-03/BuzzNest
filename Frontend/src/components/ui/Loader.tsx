...
const Loader: React.FC = () => {
  return (
    <div className="w-screen h-screen bg-black flex items-center justify-center">
      <div
        role="status"
        className="max-w-sm p-4 border border-gray-800 rounded-lg shadow animate-pulse dark:border-gray-700"
      >
        <div className="flex items-center justify-center h-48 mb-4 bg-gray-700 rounded-lg">
          <svg
        ...
        <div className="flex items-center mt-4">
          <svg
            className="w-10 h-10 me-3 text-gray-500 dark:text-gray-700"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
            viewBox="0 0 20 20"
          ...
          <div>
            <div className="h-2.5 bg-gray-600 rounded-full dark:bg-gray-700 w-32 mb-2"></div>
